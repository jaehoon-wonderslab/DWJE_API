...
class OpenApiConfig {
    ...
    companion object {
        ...
        private val DOMAIN_TAGS: List<Tag> = listOf(
            ...
            tag("10. 시스템관리 - 용어·제품", "용어 사전 (SY-06)"),
            tag("11. 시스템관리 - AI 운영", "AI 모델 설정 · Agent 실행 현황 · 자연어 질의 이력 (SY-08, SY-10, SY-12)"),
            tag("12. 시스템관리 - 운영", "지표 측정 데이터 관리 · 다운로드 이력 · 데이터 연동 이력 (SY-13~15)")
        )
